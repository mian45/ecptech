...
class IsValidPassword implements Rule
{
    ...
    /**
     * Determine if the Uppercase and lowercase Validation Rule passes.
     *
     * @var boolean
     */
    ...
    public function message()
    {
        switch (true) {
            ...
            case ! $this->lowercasePasses
                ...
                && $this->numericPasses
                && $this->specialCharacterPasses:
                return 'The :attribute must be at least 8 characters and contain at least one lowercase character.';
            ...
            case ! $this->uppercasePasses
                ...
                && $this->numericPasses
                && $this->specialCharacterPasses:
                return 'The :attribute must be at least 8 characters and contain at least one uppercase character and one lowercase.';
            
            case ! $this->uppercasePasses
                && ! $this->numericPasses
                && $this->lowercasePasses
                && $this->specialCharacterPasses:
                return 'The :attribute must be at least 8 characters and contain at least one uppercase character, one number';
            ...
            case ! $this->lowercasePasses
                ...
                && $this->uppercasePasses
                && $this->specialCharacterPasses:
                return 'The :attribute must be at least 8 characters and contain at least one lowercase character and one number.';
            ...
            case ! $this->numericPasses
                ...
                && $this->uppercasePasses
                && $this->lowercasePasses:
                return 'The :attribute must be at least 8 characters and contain at least one number and one special character.';
           
            default:
                return 'The :attribute must be at least 8 characters contain one uppercase character, one lowercase,one number and special character
                ';
        }
    }
