...
class PaidRemainderCron extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'paidRemainder:cron';
    ...
    public function handle()
    {
       ...
       $reminders = Reminder::where('is_active',1)->where('invoice_type','paid')->where('type', '!=' , 'orderComplete')->get();
